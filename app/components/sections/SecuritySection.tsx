  ...
  return (
    <section className="relative bg-black overflow-hidden border-t border-white/10">
      <div
        ...
        style={{ paddingLeft: '48px', paddingRight: '48px', paddingTop: '140px', paddingBottom: '80px' }}
      >
        <div className="grid lg:grid-cols-[1fr_2fr] gap-16">
          ...
          <div>
            <Reveal>
              <h3
                className="text-white font-light leading-[1.2] tracking-[-0.02em] mb-12 max-w-[900px]"
                style={{
